  ...
  $.getJSON('city-council/data/city-council-data.json', function( data ) {
    ...
    $.each( data, function( key, val ) {
      ...
      var jsonld = {
        ...
        "url": "https://civilserviceusa.github.io/city-council-pa-philadelphia/",
        "sameAs": []
      };
      ...
      jsonld.image = 'https://civilserviceusa.github.io/city-council-pa-philadelphia/images/headshots/512x512/' + val.name_slug + '.jpg';
      jsonld.jobTitle = toTitleCase(val.title) + ' of Philadelphia City Council';
